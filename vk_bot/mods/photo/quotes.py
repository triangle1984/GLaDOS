...
class Quote(BasicPlug, Upload):
    ...
    def setbackground(self):
        ...
        cav = Image.open("pics/cav.png")
        result.paste(cav, (180, 26), cav)
        cav2 = Image.open("pics/cav2.png")
    ...
    def makequotes(self):
        ...
        try:
            ...
            Так же, с помощью команды \'/цитата фон\' можно установить свой фон для цитаты
            Этот фон будет появляться только когда цитируют вас.
            А еще возможность изменять цвет текста, подробнее: \'/цитата цвета -h\'""")
